      ...
      <main className="flex flex-1 items-center justify-center px-4 py-12">
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              {isLogin
                ? "Melde dich an, um Taxifahrten zu teilen."
              ...
              {!isLogin && (
                <div className="flex items-start space-x-2">
                  ...
                  <label htmlFor="terms" className="text-sm leading-snug text-muted-foreground">
                    Ich habe die{" "}
                    <Link to="/agb" className="text-primary underline hover:text-primary/80" target="_blank">
                      AGB
                    </Link>{" "}
                    und{" "}
                    <Link to="/datenschutz" className="text-primary underline hover:text-primary/80" target="_blank">
